...
export const officeHealthSafetyPoints = [
  ...
  },
  {
    ...
    body: "Acoustic pods, modular furniture, and fragile equipment are dismantled, wrapped, and reassembled with care. Nothing rushed.",
  },
] as const;
...
export const officeAssumptionPoints = [
  "The price is fixed for the scope, volume, crew, trucks, access, and timeline described in this proposal, based on information supplied by the client.",
  "Delays outside our control (traffic, weather, building access, lift breakdown, parking, third-party contractors, or the site not being ready) may require additional time at $480 + GST per hour for the crew of 8, pro-rata.",
  "If actual conditions differ materially from those described, the fixed price may be adjusted. Variations will be agreed in writing where practicable before extra work starts.",
  "On-site rubbish removal and clear-up by the crew is included. A dedicated dump run can be quoted as an optional extra.",
] as const;
