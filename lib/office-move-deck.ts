...
export const officeTermsClauses: readonly OfficeTermsClause[] = [
  ...
  },
  {
    ...
    paragraphs: [
      "The price quoted is a fixed price for the scope of work, volume, crew, trucks, access conditions and timeline set out in the quote, based on information supplied by the Client. The fixed price includes dismantle, wrap, pack, transport, reassembly and rubbish removal by the crew as described, and the listed materials.",
    ],
  },
  {
    number: 3,
